...
class Level001047 extends Level001builder {
  ...
  Level001047({this.gameController}) {
    List<String> map = [
      ...
      'P_____2________2______2_____2________P',
      'P__________2________2_____2__________P',
      'P________________2______2____________P',
      'P____________________________________P',
      'P____________________________________P',
      'P____________________________________P',
      'P____________2_______________________P',
      'P____________________________________P',
      'P____________________________________P',
      'P_________3__________________________P',
      'P____________________________________P',
      'P__________3____3____3____3__________P',
      'P____________________________________P',
      'P_____________3____3____3____________P',
      'P____________________________________P',
      'P_________________3___3______________P',
      'P____________________________________P',
      'P____________________3_______________P',
      'P____________________________________P',
      'P____________________________________P',
      'P____________________________________P',
      'P____________________________________P',
