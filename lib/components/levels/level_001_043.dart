...
class Level001043 {
  ...
  Level001043({this.gameController}) {
    List<String> map = [
      ...
      '____________________________________',
      '_______B____B____B____B________P____',
      '_________B_____B____B_______________',
      '____________G_____G____________P____',
      '________________R___________________',
      '_______________________________P____',
      '____________________________________',
      '_____E_____E_____E_____E_______P____',
      '_____E_____E_____E_____E____________',
      '________E_____E_____E__________PP___',
      '_______________________________PP___',
      '____________________________________',
      '____________________________________',
