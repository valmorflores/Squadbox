...
class _ParticleEffectGameState extends State<ParticleEffectGame> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Particles Effects')),
        body: GameWidget(game: ParticlesEffects()));
  }
}

class ParticlesEffects extends FlameGame {
