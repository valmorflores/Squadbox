...
class RaycastLightEffectGame extends StatefulWidget {
  const RaycastLightEffectGame({Key key}) : super(key: key);

  @override
  State<RaycastLightEffectGame> createState() => _RaycastLightEffectGameState();
}

class _RaycastLightEffectGameState extends State<RaycastLightEffectGame> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Raycast Light Effects')),
        body: GameWidget(game: RaycastLightExample()));
  }
}
